...
Description: this is with page validation.
Version: 1.0
Author: Your Name
*/
...
function enqueue_custom_scripts() {
    wp_enqueue_style("tour-css", my_plugin_dir . '/css/tour.min.css');
    wp_enqueue_style("admin-css", my_plugin_dir . '/css/admin.css');
    wp_enqueue_style("child-css", my_plugin_dir . '/style.css');
    wp_enqueue_style("jqueryui-css", my_plugin_dir . '/css/jquery-ui.min.css');
    wp_enqueue_style("quizstyle-css", my_plugin_dir . '/css/quiz-style.css');
    wp_enqueue_style("select2-css", my_plugin_dir . '/css/select2.css');
    ...
    // Enqueue Additional Methods for jQuery Validation Plugin
    wp_enqueue_script('jquery-validation-additional', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.3/additional-methods.min.js', array('jquery'), '1.19.3', true);

    // Enqueue jQuery TagsInput Plugin
    wp_enqueue_script('jquery-tagsinput', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.min.js', array('jquery'), '0.8.0', true);
    wp_enqueue_script('select2-cdn', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js', array('jquery'), '0.8.0', true);
  // SweetAlert2 CSS
  wp_enqueue_style('sweetalert2-css', 'https://cdn.jsdelivr.net/npm/sweetalert2@11.4.4/dist/sweetalert2.min.css', array(), '11.4.4');

  // SweetAlert2 JS
  wp_enqueue_script('sweetalert2-js', 'https://cdn.jsdelivr.net/npm/sweetalert2@11.4.4/dist/sweetalert2.all.min.js', array('jquery'), '11.4.4', true);
...
register_activation_hook( __FILE__, 'mycustom_plugin_create_database_table' );
add_action('init','custom_table');
function custom_table(){
    global $wpdb;
//   echo   my_plugin_dir.'templates/template-dashboard.php';
    ...
    if($flag == false) {
        ...
        if($learning_modules[$section_id]['is_all_complated'] == '1' && !empty($if_quiz_exist)) {
         ...
         $sent = wp_mail($to,$subject,$body,$headers);
            ...
            // $response = wp_remote_post('https://apis.techoship.com/sendemail/api/send-mail', array(
            // 'body' => json_encode([
            //     'email' => $to,
            //     'subject'=>$subject,
            //     'htmlContent' => $body,
...
function fetch_img_url($turl){
    return '<img src="'.my_plugin_dir.'/images/'.$turl.'" height="30px;" width="30px;">';
}
            ...
            <tr valign="top">
                ...
                <td>
                    <div class="trophydata">
                        <div class="range-cls">
                            <p>
                                <?php echo fetch_img_url('trophygold.png'); ?>
                            </p>
                        ...
                        <div class="range-cls">
                            <p>
                                <?php echo fetch_img_url('trophysilver.png'); ?>
                            </p>
                        ...
                        <div class="range-cls">
                            <p>
                                <?php echo fetch_img_url('trophybronze.png'); ?>
                            </p>
                        ...
                        <div class="range-cls">
                            <p>
                                <?php echo fetch_img_url('trophyx.png'); ?>
                            </p>
    ...
    <div class="section-action-btn">
        ...
        <span>
            ...
            <a href="javascript:void(0);" class="notify-user" data-userid="<?php echo $user->ID; ?>">
                <img src="<?php echo my_plugin_dir?>/images/email_64.png" alt="img" />
            </a>
            <?php
                    }
                    ?>
...
add_action( 'wp_ajax_update_user_cat', 'update_user_cat' );
