    ...
    if($('#quiz_btn_timer').length == 1) {
        $(window).on('load', function(){
            ...
            setTimeout(function(){
                ...
                $('#quiz_btn_timer').siblings('.learning_modules_action_btn_quiz').children('.start_quiz').removeClass('disabled');
            ...
            if(jQuery('div[data-qid='+nextid+']').length != 0) {
                ...
                if(success == jQuery('.question-wrapper').length){
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: {
                            action: "quiz_modules_save_action_frontend",
