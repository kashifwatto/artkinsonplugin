...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  ...
  <script>
    $('.cc-list .quizresultinfo').on('click', function() {
...
function popupfunction($string, $trophy_arr, $userid, $name){
    ?>
    <div class="modal fade" id="myModal-<?php echo $string.'-'.$userid; ?>" role="dialog">
        <div class="modal-dialog">                            
        <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><?php echo $name.' - '.$string;?></h4>
                ...
                <div class="modal-body">
                    ...
                    <?php
                        ...
                        foreach($trophy_arr as $id => $val) {    
                            ...
                            $detail = get_specific_section_by_id($id);
                            if($detail) { ?>
                            <li class="cc-list">
                                <!-- <div class="acc-wrapper">
                                    <h3 class="accordion"><?php echo $detail->title;?></h3>
                                    <div class="panel">
                                        <?php //echo get_wrong_answer_list($userid,$id); ?>
                                    ...
                                    echo '<div class="progress-section">';
                                        echo '<div class="bar-top">';
                                            echo '<div class="pro-percentage">';
                                                echo '<span>'.$val['score'].'</span>';
                                            echo '</div>';
                                        echo '</div>';
                                        echo '<div class="pro-percentage-bar">';
                                            echo '<div class="current-progress '.$clsclr.'" style="width:'.$width.'"></div>';
                                        echo '</div>';
                                    echo '</div>';
