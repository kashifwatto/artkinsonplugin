...
// $coin = 25;
// $section_id = 60;
// $getcoins = json_decode(get_usermeta($user_id,'redo_course_coins',true),true);
...
include(get_stylesheet_directory().'/Mobile_Detect.php');
    ...
    <div class="main-content">
        ...
        <div class="content-left">
                                    ...
                                    <tbody class="people-list">
                                        <?php 
                                            ...
                                            foreach ($sp as $lbk => $lbv) {               
                                                $display_name = get_display_name($lbk);
                                                $name =  $display_name;
                                                $weight_arr = 0;
            ...
            if(!empty($completed_learning_modules)){
                ...
                foreach ($completed_learning_modules as $key => $value) {
                    ...
                    <li class="accordion-title">
                        ...
                        <a href="javascript:void(0);" class="show-popup accordian-text" data-showpopup="<?php echo $key; ?>">
                            <?php echo $value['title']; ?>
                            <!-- <span class="dashicons dashicons-plus-alt2"></span> -->
                        </a>
                    </li>

                    <div class="overlay-content popup" id="cmplt_<?php echo $key; ?>">
                        <button class="close-btn">x</button>
                        <div class="learning-modules box-shadows"> 
                            ...
                            <div class="top-section">
                                ...
                                <div class="learning-img-btn">
                                    ...
                                    <?php echo get_current_steps($value);?>
                                    ...
                                    <ul>
                                        ...
                                        if(!empty($value['pages'])){
                                            ...
                                            foreach ($value['pages'] as $key => $learning_subsec) {
                                                ...
                                                echo '<li class="'.$complated_class.'"  ><a href="'.$learning_subsec['sub_start_url'].'?step='.urlencode($learning_subsec['sub_title']).'">'.$learning_subsec['sub_title'].'</a></li>';
                            ...
                            <?php 
                            if($avg == ''){
                                echo get_progress_bar($total_steps, $total_completed_step );
                            }else{
                                echo get_quiz_progress_bar($avg);
                            } 
                            ?>
                        </div>
                    </div>
            ...
            <?php  //if(current_user_can( 'administrator' )) {  
                $wallet_balance = coin_shopping_get_wallet_balance($user_id);
                ?>
                            ...
                            if(!empty($results)) { ?>
                                ...
                                <?php foreach($results as $plist) { 
                                    ...
                                    <li class="<?php echo $class; ?>">
                                        ...
                                        <div class="info">
                                            <span><?php echo $plist['product_name'];?></span>
                                            <span><?php echo $plist['product_price'];?>pts</span>
                                        </div>
                                        <div class="purchase">
            ...
            <div class="shop-button">
                ...
                ?>
                    <button class="btn btn-shop" data-toggle="modal" data-target="#atlshopmodal">Shop <?php echo $wallet_balance.'pts'; ?></button>
            ...
            <div class="info-content box-shadows">
                <?php 
                    ...
                    if(empty($completed_learning_modules) || count($completed_learning_modules) == 0 && get_option('first_wlcm_message') != '') {
                        ...
                        echo 'Welcome to Atkinson Learning. Here’s where you’ll find the training courses available to you. Complete the sections below. Click START to begin or CONTINUE to resume where you left off.';
                            ...
                            <div class="learning-modules box-shadows"> 
                                ...
                                <div class="top-section">
                                    ...
                                    <div class="learning-img-btn">
                                        ...
                                        <?php echo get_current_steps($user_assigned);?>
                                        ...
                                        <ul>
                                            ...
                                            if(!empty($user_assigned['pages'])){
                                                ...
                                                foreach ($user_assigned['pages'] as $key => $learning_subsec) {
                                                    ...
                                                    echo '<li '.$complated_class.' ><a href="'.$learning_subsec['sub_start_url'].'?step='.urlencode($learning_subsec['sub_title']).'">'.$learning_subsec['sub_title'].'</a></li>';
                                ...
                                <?php echo get_progress_bar($total_steps, $total_completed_step ); ?>
