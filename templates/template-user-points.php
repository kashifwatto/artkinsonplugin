    ...
    <table id="users_table"  class="table cell-border dataTable no-footer" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="update-userpoints" data-userid="<?php echo $row['user_id']; ?>">
                        <span><?php echo $row['total_coins']; ?></span>
                        <div class="frm_updateuser_points" style="display:none;">
                            <input type="text" name="user_coins" class="user_coins" value="<?php echo $row['total_coins']; ?>" >
    ...
    jQuery(document).ready(function($){
        ...
        $('#users_table').on('click','.sbmt_uc',function(e){
            ...
            jQuery.ajax({
                ...
                type: "POST",
                data: {
                    action: 'modify_user_wallet_points',
