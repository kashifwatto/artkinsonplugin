...
if (isset($_GET['action'])) {
    if ($_GET['action'] == 'add') {
        ...
        <div class="products-top-header">
            <a href="<?php echo admin_url('admin.php?page=shop-items'); ?>">
        ...
        if($results[0]['image_icon'] != '') {
            ...
            $img = site_url().'/wp-content/uploads/2022/03/icons-camera.png';
        }
        ?>
        <div class="products-top-header">
        ...
        <div class="atl-product-wrapper">
            <div class="wrapper">
                <form action="" method="" id="edit_product_form" name="edit_product_form">
                    <div class="top-section-details">
                        <input type="hidden" name="prodid" value="<?php echo $results[0]['id']; ?>">
                        <div class="section_upload_icon">
                            <label for="prod_icon"><img width="50px" src="<?php echo $img; ?>"/></label>
                            <input id="prod_icon" name="prod_icon_attachment" type="hidden" value="<?php echo $results[0]['image_icon']; ?>" />
                        </div>
                        <div class="form-field">
                            <input type="text" name="product_title" placeholder="Product Title" value="<?php echo $results[0]['product_name']; ?>"/>
                        </div>
                        <div class="form-field">
                            <input type="text" name="product_price" placeholder="Product price" value="<?php echo $results[0]['product_price']; ?>"/>
                        </div>
                        <div class="form-field">
                            <textarea rows="5" name="product_desc" placeholder="Product description"><?php echo $results[0]['product_desc']; ?></textarea>
                        </div>
                        <div class="form-field">
        ...
        <table id="listing-table"  class="table cell-border dataTable no-footer" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="edit-product" href="<?php echo admin_url('admin.php?page=shop-items'); ?>&action=edit&pid=<?php echo $row['id']; ?>">
                        ...
                        <td>
                            <a href="#" class="delete-product" data-pid="<?php echo $row['id']; ?>">
        ...
        jQuery( "#add_product_form" ).validate({
            ...
            submitHandler: function(form) {
                ...
                jQuery.ajax({
                    ...
                    type: "POST",
                    data: {
                        action: 'insert_product_shop_items',
                        status: 'add',
                        data: formData
                    },
                        ...
                        if(data == 'success'){
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = '<?php echo site_url(); ?>/wp-admin/admin.php?page=shop-items';
                                }
                            });
                        }
                    }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    jQuery.ajax({
                        ...
                        type: "POST",
                        data: {
                            action: 'delete_product_shop_items',
                            product_id : id
                        },
                        success: function(data) {
                            if(data == 'deleted'){
