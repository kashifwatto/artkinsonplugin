<div class="learning-main-section">
	...
	<?php $learning_sections = get_learning_section_archived();?>
					...
					foreach ($learning_sections as $key => $learning_section) {
						...
						<li>
							...
							<div class="section-action-btn">
								<a href="javascript:void(0)" title="Revert" class="revert_section" data-section_id="<?php echo $learning_section->id;?>"><span class="dashicons dashicons-undo" ></span></a>
								<a href="javascript:void(0)" title="Permenantly Delete" class="delete_section" data-section_id="<?php echo $learning_section->id;?>"><span class="dashicons dashicons-dismiss" ></span></a>
			    ...
			    jQuery.ajax({
            		...
            		type: "POST",
             		...
             		data: {
             			...
             			action: 'learning_modules_delete_action_backend',
			...
			if (result.isConfirmed) {
				...
				jQuery.ajax({
					...
					data: {
						...
						action: 'learning_modules_revert_action_backend',
